...
function core.StateA()
    return readValue(PosRef(), - 0x128, ReadValue32)
end

function core.StateB()
    return readValue(PosRef(), - 0x127, ReadValue32)
end

function core.StateC()
    return readValue(PosRef(), - 0x126, ReadValue32)
end

function core.StateD()
    return readValue(PosRef(), - 0x125, ReadValue32)
end
